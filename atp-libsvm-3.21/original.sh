...
#echo ${bestGammaHinge}
########################  ramp   ########################
./CVramp.sh "./matlab/originalData/${fileName}" > "./CVforBigtable/original/${fileName}_ramp"
...
########################  pinball   ########################
./CVpinball.sh "./matlab/originalData/${fileName}" > "./CVforBigtable/original/${fileName}_pinball"
...
########################  atp    ########################
./CVATP.sh "./matlab/originalData/${fileName}" > "./CVforBigtable/original/${fileName}_atp"
...
########################  train and test ########################
#hinge
./svm-train -s 0  -g ${bestGammaHinge} -c ${bestCHinge} "./matlab/originalData/${fileName}"
./svm-predict "./matlab/originalData/${fileName}.t" "${fileName}.model" "${fileName}.t.predict"
#ramp
./svm-train -s 5 -h 0 -g ${bestGammaRamp} -c ${bestCRamp} -y 1 -i 0 -u ${bestTRamp} -o 0.0000001 "./matlab/originalData/${fileName}"
./svm-predict "./matlab/originalData/${fileName}.t" "${fileName}.model" "${fileName}.t.predict"
#pinball
./svm-train -s 5 -h 0 -g ${bestGammaPinball} -c ${bestCPinball} -y 10000000 -i ${bestTauPinball} -u -10000000 -o 0.0000001 "./matlab/originalData/${fileName}"
./svm-predict "./matlab/originalData/${fileName}.t" "${fileName}.model" "${fileName}.t.predict"
#atp
./svm-train -s 5 -h 0 -g ${bestGammaATP} -c ${bestCATP} -y ${bestSATP} -i 0.5 -u ${bestTATP} -o 0.0000001 "./matlab/originalData/${fileName}"
./svm-predict "./matlab/originalData/${fileName}.t" "${fileName}.model" "${fileName}.t.predict"
